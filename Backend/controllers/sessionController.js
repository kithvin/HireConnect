...
// Controller to fetch active sessions
export async function getActiveSessions(_, res) {
  try {
    // Fetch sessions with status "active" and populate host and participant details
...
// Controller to fetch recent sessions of the logged-in user
...
// Controller to fetch session details by ID
...
// Controller to join an active session
export async function joinSession(req, res) {
  try {
    ...
    // Ensure the session is active and not already full
    ...
    // Add the user to the chat channel
...
export async function endSession(req, res) {
  try {
    ...
    // Delete the video call and chat channel
